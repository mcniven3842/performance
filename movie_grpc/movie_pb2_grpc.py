...
class MovieStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMoviesFiltered = channel.unary_stream(
                '/Movie/GetMoviesFiltered',
                request_serializer=movie__pb2.RatingFilter.SerializeToString,
                response_deserializer=movie__pb2.MovieData.FromString,
                )
        ...
        self.CreateMovie = channel.unary_unary(
                ...
                response_deserializer=movie__pb2.FeedbackMessage.FromString,
                )
        self.UpdateMovieRating = channel.unary_unary(
                '/Movie/UpdateMovieRating',
                request_serializer=movie__pb2.RatingUpdate.SerializeToString,
                response_deserializer=movie__pb2.FeedbackMessage.FromString,
                )
        self.RemoveMovie = channel.unary_unary(
                '/Movie/RemoveMovie',
                request_serializer=movie__pb2.MovieID.SerializeToString,
                response_deserializer=movie__pb2.FeedbackMessage.FromString,
                )
...
def add_MovieServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMoviesFiltered': grpc.unary_stream_rpc_method_handler(
                    servicer.GetMoviesFiltered,
                    request_deserializer=movie__pb2.RatingFilter.FromString,
                    response_serializer=movie__pb2.MovieData.SerializeToString,
            ),
            ...
            'CreateMovie': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=movie__pb2.FeedbackMessage.SerializeToString,
            ),
            'UpdateMovieRating': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateMovieRating,
                    request_deserializer=movie__pb2.RatingUpdate.FromString,
                    response_serializer=movie__pb2.FeedbackMessage.SerializeToString,
            ),
            'RemoveMovie': grpc.unary_unary_rpc_method_handler(
                    servicer.RemoveMovie,
                    request_deserializer=movie__pb2.MovieID.FromString,
                    response_serializer=movie__pb2.FeedbackMessage.SerializeToString,
            ),
    }
...
class Movie(object):
    ...
    def GetMoviesFiltered(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Movie/GetMoviesFiltered',
            movie__pb2.RatingFilter.SerializeToString,
            movie__pb2.MovieData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CreateMovie(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Movie/CreateMovie',
            ...
            movie__pb2.FeedbackMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateMovieRating(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Movie/UpdateMovieRating',
            movie__pb2.RatingUpdate.SerializeToString,
            movie__pb2.FeedbackMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RemoveMovie(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Movie/RemoveMovie',
            movie__pb2.MovieID.SerializeToString,
            movie__pb2.FeedbackMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
